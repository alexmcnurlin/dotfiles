...
if [ ! -e ~/.dotfiles/custom_scripts/rofi-dmenu ]; then
	cp ~/.dotfiles/custom_scripts/rofi-dmenu-default ~/.dotfiles/custom_scripts/rofi-dmenu
fi

if [ ! -e ~/.dotfiles/dunst/dunstrc ]; then
	cp ~/.dotfiles/dunst/dunstrc_default ~/.dotfiles/dunst/dunstrc
fi
	...
	sed -e "s/\(-bc \"#\)[0-9a-fA-F]\{6\}/\1$bgcolor/g" -i   ~/.dotfiles/custom_scripts/rofi-dmenu
	sed -e "s/\(-bg \"#\)[0-9a-fA-F]\{6\}/\1$bgcolor/g" -i   ~/.dotfiles/custom_scripts/rofi-dmenu
	sed -e "s/\(-fg \"#\)[0-9a-fA-F]\{6\}/\1$fgcolor/g" -i   ~/.dotfiles/custom_scripts/rofi-dmenu
	sed -e "s/\(-hlbg \"#\)[0-9a-fA-F]\{6\}/\1$fgcolor/g" -i ~/.dotfiles/custom_scripts/rofi-dmenu
	sed -e "s/\(-hlfg \"#\)[0-9a-fA-F]\{6\}/\1$bgcolor/g" -i ~/.dotfiles/custom_scripts/rofi-dmenu
